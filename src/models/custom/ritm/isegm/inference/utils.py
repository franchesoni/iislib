...
from models.custom.ritm.isegm.data.datasets import GrabCutDataset, BerkeleyDataset, DavisDataset, SBDEvaluationDataset, PascalVocDataset
from models.custom.ritm.isegm.utils.serialization import load_model
...
def load_is_model(checkpoint, device, **kwargs):
    ...
    if isinstance(state_dict, list):
        ...
        # hack it to iis_framework
        state_dict['config']['class'] = 'models.custom.ritm.' + state_dict['config']['class']
