...
class EarlySMP(torch.nn.Module, smp.encoders._base.EncoderMixin):
    def __init__(self, smp_model_class, smp_model_kwargs_dict, in_channels=6, classes=1):
        super().__init__()
...
class EncodeSMP(torch.nn.Module, smp.encoders._base.EncoderMixin):
    def __init__(self, smp_model_class, smp_aux_model_class, smp_model_kwargs_dict, smp_aux_model_kwargs_dict, smp_model_classes=1):
        super().__init__()
