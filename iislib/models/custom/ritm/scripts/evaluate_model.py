...
from models.custom.ritm.isegm.utils.vis import draw_probmap, draw_with_blend_and_clicks
...
def parse_args():
    ...
    parser.add_argument('--config-path', type=str, default='models/custom/ritm/config.yml',
